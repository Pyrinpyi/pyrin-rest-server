...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_pyrin_info, \
...
from endpoints.pyrin_requests.submit_transaction_request import submit_a_new_transaction
...
print(
    ...
    f"{get_pyrin_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
...
async def startup():
    ...
    # find pyrin before staring webserver
